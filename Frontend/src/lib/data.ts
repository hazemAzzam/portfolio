...
export const PROJECTS_DATA: ProjectType[] = [
  ...
  },
  {
    ...
    overview:
      "Built a comprehensive portfolio generation platform that allows developers to create professional portfolio websites through an intuitive drag-and-drop interface.",
    detailedDescription:
  ...
  },
  {
    ...
    overview:
      "Developed a smart recipe discovery application that helps users find recipes based on available ingredients, dietary restrictions, and personal preferences.",
    detailedDescription:
